...
public abstract class Terminal implements ConsoleOperations {
     ...
     *  @see #setupTerminal
     */
    public static Terminal getTerminal(Writer w) {
        return setupTerminal(w);
    }
     ...
     */
    public static synchronized Terminal setupTerminal(Writer w) {
        if (term != null) {
            return term;
        }
        ...
        String termProp = System.getProperty("terefang.jline.terminal");
     ...
     *  character echo.
     */
    public abstract void initializeTerminal(Writer w) throws Exception;
    ...
    public InputStream getDefaultBindings() {
        ...
        return Terminal.class.getResourceAsStream(
                System.getProperty("os.name").toLowerCase().startsWith("mac") ?
                    "/terefang/jline/keybindings-mac.properties" : "/terefang/jline/keybindings.properties");
    }
}
